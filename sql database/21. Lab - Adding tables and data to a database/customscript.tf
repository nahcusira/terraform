...
resource "azurerm_storage_account" "vmstoredsafghdasgfhj" {
...
resource "azurerm_virtual_machine_extension" "vmextension" {
  ...
  settings = <<SETTINGS
    {
        "fileUris": ["https://${azurerm_storage_account.vmstoredsafghdasgfhj.name}.blob.core.windows.net/scripts/Script.ps1"],
