...
New-AzureADMSConditionalAccessPolicy -DisplayName "4. Require multifactor authentication for admins accessing Microsoft admin portals" -State "enabledForReportingButNotEnforced" -Conditions $conditions -GrantControls $controls